...
const PlaceAddPage = () => {
    ...
    const addPlace = async () => {
        ...
        const response = await api.post(`places/create/`, {}, {
            headers: {
        ...
        if (response.status == 200){
            const place_id = response.data["id"]
            await updatePlace(place_id)
        }

    }

    const updatePlace = async (place_id) => {
        ...
        const response = await api.put(`places/${place_id}/update/`, form_data, {
            headers: {
            ...
            <div className="right">
                ...
                <div className="info-container">
                    ...
                    <div className="buttons-container">
                        ...
                        <CustomButton bg={variables.green} onClick={addPlace}>
                            Создать
                        </CustomButton>
